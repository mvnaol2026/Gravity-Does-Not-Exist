...
We have seen that motion does not arise in and of itself. We have seen that it requires contact pressure. We have seen that this principle operates within solid bodies, liquids, and gases. Consequently, we have assumed that it is logical to expect its continuation at a deeper level — which is to say, everywhere.

But now, a fundamental question arises.  
Very well. Pressure causes motion.  
**But what creates the pressure itself?**  
**What is the source of all these interactions?**

If we fail to answer this question, the picture will remain incomplete. We will see the effects, but we will not comprehend the cause.

Let us begin with something simple.  
You push an object. In this case, everything is obvious: you create the pressure. Your motion is caused by the work of your muscles; the work of your muscles is the result of processes within your body, and those, in turn, depend on chemical reactions.

If we continue this chain, it becomes clear: not a single motion arises "on its own." It is always linked to another motion.  
One process triggers another.  
One form of motion is transmitted further along.  
And if we do not break this chain, a highly vital conclusion suggests itself: matter can only be set in motion by other matter already in motion.

No "abstract force" arrives from the outside. No "energy" on its own initiates a process. There is always a specific motion that is transmitted further.

It is not that "something acts upon something else," but rather that something is in motion and transmits that motion further down the line.

And this is where we approach the boundary of our familiar experience.  
Because as we trace this chain of motions, a question inevitably arises at some point: **"What sets the world itself in motion?"**

Not an individual object, not a mechanism, not a stream of water—but everything all at once?  
What creates the pressure that leads to motion at a level where "hands," "pumps," and "wind" no longer exist? "Hands," "pumps," and "wind" are merely the "tip of the iceberg" — the final elements in the chain of motions. What, then, lies at the base of the "iceberg"?

If space is indeed empty, as is commonly believed, there is no answer.  
Too many difficulties are associated with the void.  
And the most significant of them is that a void can achieve nothing.  
It cannot exert pressure.  
It cannot transmit motion.  
It cannot act as a support. 

Imagine two objects. Between them lies a void. One object must somehow influence the other. How will this happen?  
If there is truly nothing between them, then there is simply nothing to transmit the interaction.

One could, of course, say: **"through a field."** This is exactly what official science claims.    
But then the next question immediately arises: **what exactly is a field?**

If it genuinely acts, it must be something. It must have a carrier. It must consist of something, or at the very least, be transmitted through something. Otherwise, we have merely replaced one riddle with another.

To say "the interaction is transmitted through a field" is not yet an explanation. It is only a new name for an misunderstood mechanism.

**The Trap of Abstractions: Why the Concept of a "Physical Field" Is Logically Untenable**

Modern academic science prides itself on its precision, yet a gigantic logical contradiction lies at its very foundation. In attempting to explain how one body acts upon another at a distance (through an absolute void), physics repeatedly commits the exact same error: it substitutes real mechanical objects with mathematical abstractions.

The foremost of these abstractions is the "physical field."  
If we strip the complex formulas from the textbooks and ask official science questions regarding the nature of the field, it turns out that both classical and quantum theories have led humanity into a dead end. Let us break down the flaws in the logic of both concepts.

**Part 1. The Classical Field: The Oscillation of "Nothing" in "Nothingness"**

In classical electrodynamics (Maxwell's theory), the field is described as a specific continuous "fabric" that fills the empty space surrounding charges. It does not consist of particles, it lacks mechanical boundaries, yet it is allegedly real.  
Here, official logic breaks down in three places:

**1. The Paradox of the Physical Properties of the Void**
Science asserts that a vacuum is an absolute void devoid of matter. Yet, this very "void" officially possesses fundamental physical constants: vacuum permittivity and magnetic permeability. The speed of light is calculated from these very values.  
But a physical property cannot exist on its own! A property is always a characteristic of something material. To claim that a void has permittivity and permeability is equivalent to saying that a non-existent cat possesses a specific fur color and claw density.

**2. The Absurdity of a Wave Without a Mediator**  
Classical physics acknowledges that light and radio waves are oscillations of the electromagnetic field. But what is an oscillation according to the laws of mechanics? It is a physical process where material elements of a medium displace relative to one another.  
If the field does not consist of material particles, then to what exactly does the momentum of motion belong? What concretely compresses, decompresses, and oscillates while a wave propagates from the Sun to the Earth? The oscillation of an absolute void is merely a linguistic trick masking the absence of a physical mechanism.

**3. The Infinite Energy of a Point**  
If an electron is a structureless, point-like material particle that creates a classical field around itself, then according to Coulomb's law, the energy density of this field at the very center of the electron approaches infinity  
To prevent the electron from exploding due to its own infinite energy, physicists had to invent the procedure of "renormalization" — that is, the artificial, mathematical subtraction of infinities from infinities in order to fudge the formula to match the expected answer.

**The Upshot of the Classical Viewpoint:**  
Physicists were forced to believe in a non-material, mystical "aura" that possesses mechanical properties (energy and momentum) but fundamentally consists of nothing at all.

**Part 2. The Quantum Field: Virtual Magic and Mathematical Fraud**  
Realizing that the oscillations of "nothing" sounded unconvincing, scientists created Quantum Field Theory (QFT) in the mid-20th century. They declared that there are numerous fields (electron, photon, quark... 24 fields in total), that they are primary, and that particles are simply "excitations" of these fields.  
To explain how force is transmitted, QFT introduced the concept of virtual particle exchange. And it is precisely here that the logic of science ultimately surrendered to mysticism.

**1. Ghost Particles**  
What is a "virtual particle" (for instance, a virtual photon that carries the magnetic force)? The official definition in QFT states that these are particles which fundamentally cannot be detected by any instrument. They are born from the vacuum for a fleeting moment and immediately vanish.  
Furthermore, they are officially permitted to travel faster than the speed of light and to temporarily violate the law of conservation of energy (allegedly borrowing energy "on credit" from the void according to the uncertainty principle). A physics that explains the real world through invisible, undetectable objects that violate basic conservation laws is no longer science — it is a religious dogma.

**2. The Mechanical Paradox of Attraction**  
Imagine two electrons. They exchange virtual photons. The first shoots a photon (receiving a backward recoil), and the second catches the photon (receiving an impact and flying backward). The electrons have repelled each other. Here, the logic works, albeit with a stretch. But how does quantum physics explain attraction (for example, between an electron and a proton)? It claims that, in this case, the virtual photon carries a "negative momentum."  
Try to visualize this mechanically: you throw a basketball at someone, the ball flies forward, strikes the person, but instead of pushing them away, it pulls them toward you! This is absurd. Upon impact, a flying object can only push (press). Quantum physics introduced "negative momentum" solely on paper to rescue the minus sign in its equations, completely abandoning common sense.

**3. The Vacuum Catastrophe (The Greatest Miscalculation in History)**  
If quantum fields are real, then the vacuum should literally boil with the energy of continuously emerging virtual particles. Physicists decided to calculate the density of this vacuum energy.  
The result of these calculations turned out to be 10<sup>120</sup> times greater than the actual value observed in astronomy! That is a one followed by 120 zeros. In any other science, a calculation error of 120 orders of magnitude would lead to the immediate closure of the department and the admission that the theory is wrong. Yet, academic physics simply labeled it an "interesting paradox" and continued teaching students from the same textbooks.

To help you grasp the monstrous scale of this error, consider the numbers. According to official estimates, the entire gigantic Observable Universe — with all its trillions of galaxies and stars — contains only about 10<sup>80</sup> atoms. The discrepancy between reality and the physicists' calculations is a factor of 10<sup>40</sup>.

What does this mean? If you chose to gather that many ordinary atoms, they would physically not fit into our world. They would require roughly two billion completely filled Observable Universes.  
If we replace the atoms with tiny grains of sand, then 10<sup>120</sup> grains of sand would tightly pack one hundred octillion (10<sup>29</sup>) universes just like ours.  
And official science shamefully dismisses this fantastic blunder as merely an "interesting paradox."

**The Upshot on Fields**

Over the course of a century, official physics has fantasized 24 different, superimposed, invisible fields.  
The principle of "Occam's razor" states that entities must not be multiplied beyond necessity. Yet, when official science forces 24 different invisible substances to simultaneously coexist at the exact same point in space (and even attempts to add a 25th — gravity — to them), it flagrantly violates this very principle.  
It is obvious that such complications are a hallmark of a dead end.

Imagine an engineer trying to explain the operation of a complex mechanical machine tool. Instead of describing the gears, belts, and shafts, he declares: "Within the machine, there exists an independent gear field, a belt field, and a shaft-rotation field. They are non-material, yet they exchange virtual pulleys."  
Any design engineer would be laughed out of the room for such an approach. Yet, this is precisely what quantum physics did: failing to describe the hidden mechanics of the medium, it simply labeled every single component as a separate, mystical field.

**The Only Logical Way Out**  
All these logical flaws, paradoxes, and mathematical crutches are the direct consequence of a single primal error.  
Science stubbornly refuses to acknowledge the obvious: space is not empty.  
There is no such thing as "action at a distance." There are no "negative momentums" and no "oscillations of the void."  
Nature is structured economically: it has no need for two dozen mystical fields when all of their effects can be explained by the mechanical vibrations and pressure of a single, real medium.

Imagine the motion of a body.  
If the body is truly in an absolute void, then what does it push against when attempting to begin moving? What does it use to resist the initiation of motion? And what will sustain its motion once the external push has ended?

If there is no medium whatsoever between the body and the rest of the world, then the entire idea of interaction becomes bizarre. It would mean that an object must either move on its own or resist within itself, completely without a support. But this already contradicts the simplest real-life experience.

To press, a support is required.
To transmit pressure, contact is required.
For contact to exist, a medium — or at least a chain of material elements — is required.
The void provides none of these.

If motion exists (and it does), if interaction exists (and it does), if the transfer of motion exists (and it does), then there must be something material between objects through which all of this transpires. Otherwise, the world turns into a collection of miracles that one simply has to take on faith.

Space is not empty.  
It is filled.  
Not with air, not with gas, not with any familiar bodies, but with a deeper medium. A medium that is present everywhere. A medium in which all objects — from an atom to a galaxy — are immersed.

The moment we restore a fully material, super-dense, continuously vibrating medium composed of real elements back into physics, the trap of abstractions vanishes. We no longer need to invent "attraction."

Everything falls into its rightful, causal place:  
• There is no attraction — there is only the external mechanical pressure of a vibrating medium.  
• There is no abstract electromagnetic field—there is only a wave of vibration within this specific material medium.  
• There is no virtual ghost particles—there is only the contact interaction of the medium's elements with the geometric structure of atoms.

The world is structured simply, logically, and mechanistically. It is time to purge physics of a century's worth of mathematical fantasies.

In this book, such a medium is called the **aol space.**  
It is highly critical to eliminate a potential misunderstanding right away.

When I say "medium," you should not picture something akin to a fog or a liquid in which objects swim like fish in water. We are speaking of a medium that is far denser, more fundamental, and incomparably more universal.

It does not simply "fill the gaps."  
It is what we commonly refer to as space.  
Space itself is matter. It is simply matter of a distinct level.

What must such a medium be like if all processes truly occur through it?  
**First**, it must be continuous. Otherwise, fractures and empty gaps would open up once again, through which no interaction could be transmitted.  
**Second**, it must be capable of exerting pressure. Otherwise, it would be unable to set anything in motion.  
**Third**, it must be capable of vibrations. Otherwise, it would be impossible to explain light, heat, oscillations, and much else.  
**Fourth**, it must be dense enough to serve as a support for motion, yet subtle and universal enough to permeate everything. 

The aol space is precisely this kind of medium.  
Without diving too deeply into the details for now, you can visualize it as a medium consisting of a colossal number of identical primary elements. Later, we will call them aols and break down their properties in detail. 

For the moment, the core concept itself is what matters to us:
**There is a material medium between bodies.**

And this single thought changes almost everything.  
It immediately becomes clearer how we can discuss the transfer of motion at all. If space is filled, then any push does not vanish into a void but is transmitted further along through the medium.

It immediately becomes clearer how pressure is possible without any visible contact between bodies. If there is a medium between them, the interaction can travel through it along a chain.

It immediately becomes clearer how light, electrical processes, magnetic vortexes, and gravitational pressing together can exist. In all these cases, we no longer need to invent different entities. It is enough to acknowledge that there is always one and the same mediator between bodies — the aol space.

And here, it is essential to emphasize one more thing.  
**This medium is not passive.**  
It does not simply "exist."

**It acts actively:**  
1. It exerts pressure.
2. It vibrates.
3. It transmits motion.
4. It forms structures.
5. It destroys structures.
6. It supports processes.

In this sense, the aol space is not a background decoration of the world. It is its primary participant.  
And here we arrive at a thought that will have to be repeated many times later, because it is truly central: **the Primary Mover of all processes in the Universe is the aol space.**
...
Rather, it is the medium itself that continuously presses and vibrates.  
It creates objects.  
It holds objects together as objects.  
It rearranges matter.  
It transmits motion from one object to another.  
From this perspective, everything we observe in the world is simply different behavioral forms of the exact same material foundation.

If we accept this thought, then everything else begins to reconfigure:  
• Light can no longer be explained as "flying photons."  
• Electricity can no longer be explained as "running charges."  
• Gravity can no longer be explained as "attraction."  
• Inertia can no longer be explained as "the inherent property of a body to move on its own."

In all these cases, we will have to ask: how does the medium — the Primary Mover — behave? What pressure does it create? How does it transmit motion?  
And it is precisely this that will make physics mechanical and understandable once again.

A natural question may arise: **very well, but if space is filled with some kind of medium, why do we not notice it?**

The answer here is very simple.  
For the exact same reason that a fish does not notice water as something separate until a current, pressure, or resistance arises. We do not live alongside this medium; we live inside it. We ourselves are part of a world built within it and out of it. We consist of the very same elements as the medium, and we require the vibrations and pressure of this medium to exist. Later, you will understand why.

Furthermore, a human being does not notice everything that exists, but only that which acts upon their senses in an accessible form. For a long time, gas was invisible and far from obvious. Electricity was too. Magnetic interaction — even more so. The absence of direct vision does not imply the absence of the medium itself.

Sometimes it is quite the opposite: precisely because the medium is everywhere, it ceases to be perceived as something separate and begins to seem like a "natural background."  
And then, a human takes the next erroneous step and declares this background to be a void.

**To Summarize**  

The void is far too weak an assumption for the real world. It explains nothing because it can achieve nothing.  
If motion, the transfer of interaction, and pressure exist in the world, then space cannot be nothing. It must be something.  
In this model, that "something" is the aol space — a continuous, dense, material medium that fills the Universe and participates in all processes.  

In the next chapter, we will take the next step — we will attempt to understand what this medium consists of. Because if space is matter, it must possess its own elements.  
And if that is the case, it is time to get acquainted with them.
