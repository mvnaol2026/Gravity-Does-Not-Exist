# Три системные ошибки в фундаменте официальной науки
...
**Не бывает движения без контакта** — и это железобетонная база знаний будущей физики. Полный разбор механизмов этого давления, природы инерции и устройства первоматерии читайте в главах книги "Притяжения не существует" [Aol_Physics_Full_Book_RU.md](Aol_Physics_Full_Book_RU.md).
