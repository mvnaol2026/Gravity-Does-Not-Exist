...
Космическое空间 (пространство) заполнено жесткой аольной матрицей, вибрирующей на базовой частоте \(\approx10^{13}\) Гц. Этот изотропный, всенаправленный гул давит на любое пассивное тело абсолютно одинаково со всех сторон. В условиях изоляции тело покоится, так как градиент давлений равен нулю.
...
## 5. Физика массы: Почему \(M_{inertial} \equiv M_{gravitational}\) без постулатов ОТО
