...
Without going into detail for now, it can be imagined as a medium composed of an enormous number of identical primary elements. Later, we will call them aols and examine their properties in detail. For now, the key idea is simple:
there is no “nothing” between objects.
