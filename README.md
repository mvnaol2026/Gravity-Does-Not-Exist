...
<details>
<summary><b>🛠️ КРАТКИЙ ИНЖЕНЕРНЫЙ ПАСПОРТ МОДЕЛИ КТА И РУКОВОДСТВО ПО КОДУ (ДЛЯ РАЗРАБОТЧИКОВ) — НАЖМИТЕ, ЧТОБЫ РАЗВЕРНУТЬ</b></summary>
...
* **Субстрат (Аольная матрица):** Пространство плотно заполнено жесткими моно-элементами (аолами/лунолами). Изменение координат макротел — это перестройка структуры тесноты.
...
* **Импульсный ход:** Свет, ток и взаимодействия — не полет безмассовых фантомов, а цепочки последовательных механических ударов (кинематика "колыбели Ньютона") без переноса массы среды.
