...
20. **Quantum**: A discrete, portioned energy of a single collision of an atom against the aols of space, followed by the mechanical transmission of this micro-impact from aol to aol along the chain. The physics of the microworld is quantum, but with quanta that are inherently different. There is no physical flight of quanta through emptiness.
