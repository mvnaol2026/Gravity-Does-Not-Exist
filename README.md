...
15. **Equivalence of Mass**: Mass is the volumetric aol windage (displacement) of a body. A body displaces exactly as many free aols from the medium as there are bound particles contained within its LEGO-like structure. With inertial mass, the body is pressed into the resisting medium. With gravitational mass, the medium presses on the body. The volume of displacement is identical, which is why inertial mass always equals gravitational mass **M<sub>inertial</sub> = M<sub>gravitational</sub>**
