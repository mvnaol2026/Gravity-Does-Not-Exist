...
11. **Albert Michelson's Experiment**: The aol space possesses different properties than the ether Michelson was searching for. Due to the dense packing of aols, a light beam always traversed a strictly equal number of them within the arms of the apparatus. Neither the Earth's motion, the rotation of the interferometer, nor the direction of the optical path altered this count. Since light propagates mechanically from particle to particle, traversing the same number of aols naturally resulted in the same travel time, which was mistakenly interpreted as the constancy of the speed of light in a vacuum.
...
11. **Эксперимент Альберта Майкельсона**: Аольное пространство обладает иными свойствами, нежели эфир, который искал учёный. Из-за плотной упаковки аолов световой луч в плечах прибора всегда преодолевал строго равное их количество. Ни движение Земли, ни поворот интерферометра, ни направление оптического пути не меняли это число. Поскольку свет передается механически от частицы к частице, прохождение одинакового количества аолов закономерно давало одинаковое время пути, что ошибочно приняли за постоянство скорости света в пустоте.
