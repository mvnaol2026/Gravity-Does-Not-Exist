...
16. **Inertia and Wedges**: Inertia is the resistance of a dense medium when a body is pressed into it. During motion, the displaced aols are driven by the medium behind the body in the form of "aol wedges", pushing it forward. There is no kinetic energy — there is only the continuous action of the wedges tightening from behind. *Inseparability from space*: A body is incapable of detaching from the aol space either at rest or in motion. At rest, the medium presses upon it from all sides absolutely equally. *Dynamic balance*: In motion, the frontal resistance of the dense packing does not decelerate the object, as it is completely balanced by the non-lagging rear pressure of the collapsing medium. *Prevailing pressure*: The "aol wedge" driven from behind disrupts this balance, creating a local excess of density strictly behind the body. This generates a prevailing vector pressure that drives the body forward, sustaining its motion.
17. **The Illusion of Time**: Time does not exist as a fundamental physical dimension. The slowing down of "time" in relativistic experiments is simply the deceleration of the rate of physical processes due to changes in the local properties and pressure of the aol medium.
18. **Black Holes**: Supermassive objects acting as wave summator-accumulators. They vibrate at frequencies higher than light (X-ray and gamma-ray ranges), actively interacting with the surrounding aol medium.
