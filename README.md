...
9. **The Mechanism of Gravity**: Gravity is a mechanical compression (pressing) of bodies toward each other caused by vibrational screening. Physical bodies (consisting of aols and lunols) partially shadow and weaken the micro-vibrations of the medium **(10<sup>13</sup> Hz)** passing through them. Due to this pressure gradient, the external aol space physically presses bodies toward each other. It is impossible to completely shield vibrational pressure. The difference in weight between the Earth and the Moon is due to varying degrees of shielding.
